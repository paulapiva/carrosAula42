class Game {
  constructor() {
    ...
    this.blast = false; //flag explosão
  }
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //obtem a propriedade de vida dos carros
  ...
  handlePlayerControls() {
    if (!this.blast) { //se estiver destruído não funcionará os constroles
      ...
      if (keyIsDown(LEFT_ARROW) && player.positionX > width / 3 - 50) {
        this.leftKeyActive = true; //flag tecla esquerda pressionada
        player.positionX -= 5;
        player.update();
      }

      if (keyIsDown(RIGHT_ARROW) && player.positionX < width / 2 + 300) {
        this.leftKeyActive = false; //flag tecla esquerda pressionada
        player.positionX += 5;
        player.update();
      }
    }
